...
class UserViewSet(viewsets.GenericViewSet):
    ...
    def updatePassword(self, request):
        ...
        if (request.data['password'] != ''):
            ...
            oldData['password'] = UserModelSerializer(user).data['password']
            
        serializer = UserModelSerializer(user, data=oldData, partial=True)
    ...
    def updateStaff(self, request):
        ...
        if (request.data['is_staff'] != ''):
            ...
            oldData['is_staff'] = UserModelSerializer(user).data['is_staff']
